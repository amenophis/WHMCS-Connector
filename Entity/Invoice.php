...
class Invoice extends Entity
{
  ...
  public static function findOne($params, Connector $connector = null)
  {
    ...
    return self::makeInstance($connector->execute('getinvoice', $params));
  }
  ...
  public static function find($params, Connector $connector = null)
  {
    ...
    $invoices = array();
    $response = $connector->execute('getinvoices', $params);
    $data = $response->getValue('invoices');

    foreach ($data->invoice as $invoice)
    {
      array_push($invoices, self::makeInstance($invoice));
    }
